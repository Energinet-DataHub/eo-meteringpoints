...
Revision ID: 0a35bff916bc
Revises: 
Create Date: 2021-10-26 11:11:23.054602
...
def upgrade():
    ...
    sa.Column('type', sa.Enum('production', 'consumption', name='energydirection'), nullable=True),
